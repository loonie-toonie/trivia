 ...
 *
 * Question shape:
 *   { id, prompt, options, correct, answer, points, label, media, done }
 *
...
function mc(points, prompt, options, correct, extra = {}) {
  return {
    id: uid('q'),
    prompt,
    options,
...
function open(points, prompt, answer, extra = {}) {
  return {
    id: uid('q'),
    prompt,
    options: [],
      ...
      /* ══ Round 1 — General Knowledge ═══════════════════════ */
      {
        ...
        categories: [
          cat('Pop Culture', '🎬', '#f9a8d4', [
            mc(100, 'Who made the phrase “Hakuna Matata” famous?', [
              'Alex and Marty',
              'Shrek and Donkey',
            ...
            mc(200, 'This video features a famous tune often used in TikTok challenges. What is the name of the tune?', [
            ...
            mc(300, 'Which of these singers performed at the 2026 FIFA World Cup Final Halftime Show?', [
              'Madonna',
              'Justin Bieber',
              'Harry Styles',
              'Jennifer Lopez',
          ...
          cat('History and Geography', '🌍', '#93c5fd', [
            mc(100, 'Based on the video, where is this famous historical site located?', [
              'Luxor, Egypt',
              'Petra, Jordan',
              'Baalbek, Lebanon',
              'Cappadocia, Türkiye',
            ...
            mc(200, 'Whose assassination triggered the beginning of World War I?', [
            ...
            mc(300, 'Which pin on the map shows the location of Croatia?', [
              'Pin A',
              'Pin B',
              'Pin C',
              'Pin D',
          ...
          cat('Sports and Nutrition', '⚽', '#fcd34d', [
            mc(100, 'Which of these fruits contains the most calories per 100 grams?', [
              'Banana',
              'Mango',
              'Pineapple',
              'Avocado',
            ...
            mc(200, 'This video shows one of the most infamous incidents in World Cup history. Which player bit his opponent during the match?', [
              'Pepe',
              'Sergio Ramos',
              'Luis Suárez',
              'Diego Costa',
            ...
            mc(300, 'Erling Haaland has inspired many viral memes — but which one did he reveal is his personal favourite?', [
              'A',
              'B',
              'C',
              'D',
      ...
      /* ══ Round 2 — Lebanese Edition ════════════════════════ */
      {
        ...
        categories: [
          cat('Guess the Logo', '⭐', '#fcd34d', [
            mc(100, 'Which brand does this blurred logo belong to?', [
              'Ghandour Bakery',
              'Gandour',
              'Ghrawi',
              'Gouté Snacks',
            ...
            mc(200, 'Which Lebanese dessert brand does this blurred logo belong to?', [
              'Better from Scratch',
              'X & Dough',
              'Xtra Dough',
              'Xtreme Donuts',
            ...
            mc(300, 'Which brand does this blurred logo belong to?', [
              'Dunkin’ Donuts',
              'Krispy Kreme',
              'Wooden Bakery',
              'Netflix',
          ...
          cat('Lebanese Proverbs', '💬', '#a78bfa', [
            mc(100, 'أي مثل بيوصف هالصورة؟ — Which proverb matches the picture?', [
              'دق الحديد وهو حامي',
            ...
            mc(200, 'أي مثل بيوصف هالصورة؟ — Which proverb matches the picture?', [
            ...
            mc(300, 'أي مثل بيوصف هالصورة؟ — Which proverb matches the picture?', [
          ...
          cat('Lebanese Music', '🎵', '#5eead4', [
            mc(100, 'What is Wael Kfoury’s real name?', [
              'Wael Michel Kfoury',
              'Michel Emile Kfoury',
              'Wael Joseph Haddad',
              'Michel Wael Saad',
            ...
            mc(200, 'Who was the first Lebanese singer to sing at the FIFA World Cup?', [
              'Nancy Ajram',
              'Myriam Fares',
              'Fairuz',
              'Carole Samaha',
      ...
      /* ══ Round 3 — Challenge Time! (under construction) ════ */
      {
        ...
        categories: [
          cat('Challenge Time!', '🔥', '#f87171', [
            ...
            open(500,
              'You just saw seven seconds from a video regarding a famous Lebanese song. Can you guess its name?',
...
export function blankQuestion(points = 100) {
  return { id: uid('q'), prompt: '', options: [], correct: -1, answer: '', points, label: '', media: null, done: false };
}
